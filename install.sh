...
install_kratos() {
  ...
  # shell-metacharacter exposure. oauth2.client_id / client_secret slots
  # stay empty because the template's `provider: null` disables the
  # downstream-oauth flow; Kratos tolerates empty strings there.
  sed \
    ...
    -e "s|{{\.KratosClientID}}||g" \
    -e "s|{{\.KratosClientSecret}}||g" \
