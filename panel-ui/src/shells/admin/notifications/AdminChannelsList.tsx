// AdminChannelsList — admin list of notification channels (M14 Step 6).
//
// Mirrors AdminIPList.tsx: useTableURL + SearchableTable + mutation
// handlers. Create + Edit use a shared Drawer (AdminChannelDrawer).
import { Button, Card, Popconfirm, Space, Switch, Table, Tag, Typography, message } from "antd";
import { useState } from "react";

import { BellOutlined, DeleteOutlined, EditOutlined, PlusOutlined, SendOutlined } from "@icons";
...
export const AdminChannelsList = () => {
